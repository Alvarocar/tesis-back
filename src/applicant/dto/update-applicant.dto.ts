...
export class UpdateApplicantDto {
  ...
  @Length(6, 20, { message: 'La identificación debe tener entre 6 y 20 caracteres' })
  ...
  @IsDateFormat('DD-MM-YYYY', { message: 'La fecha de nacimiento debe tener el formato DD-MM-YYYY' })
  @Transform(({ value }) => value?.trim())
  birthDate: string;
