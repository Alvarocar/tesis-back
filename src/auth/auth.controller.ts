import { Controller, Get, Post, Body, Patch, Param, Delete, HttpCode, ValidationPipe, Put } from '@nestjs/common';
...
export class AuthController {
  ...
  @Post('/sign-up')
  @HttpCode(201)
  async createApplicant(@Body(new ValidationPipe({ transform: true })) createApplicantDto: CreateApplicantDto) {
 ...
 /*  @Post('/sign-up/employee')
  ...
  async signInEmployee(
    ...
    return { data: new CreatedApplicantDto({
      email: employee.email,
      firstName: employee.firstName,
      lastName: employee.lastName,
      id: employee.id,
